...
class AccountProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['account_id', 'email', 'name', 'phone_number', 'bio', 'profile_image', 
                  'role', 'email_verified', 'created_at', 'monthly_rank', 'badge', 
                  'verified_reports', 'pending_reports', 'total_reports']
        read_only_fields = ['account_id', 'email', 'role', 'email_verified', 'created_at', 
                          'monthly_rank', 'badge', 'verified_reports', 'pending_reports', 'total_reports']
    ...
    def get_pending_reports(self, obj):
        """Get current user's pending reports count (status='Pending')"""
        try:
    ...
    def get_total_reports(self, obj):
        """Get current user's total reports count"""
        try:
            from reports.models import Report
