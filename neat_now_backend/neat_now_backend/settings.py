"""
Django settings for neat_now_backend project.
...
SECRET_KEY = 'django-insecure-)n$ks$li$2)&mon!392fgng-80p=yv@&y&phw)*_-qm)3d-h)%'
...
ROOT_URLCONF = 'neat_now_backend.urls'
...
WSGI_APPLICATION = 'neat_now_backend.wsgi.application'
...
# EMAIL_HOST_PASSWORD = 'your-app-password'  # Set your email app password (not regular password)
